...
El análisis de datos atraviesa el proyecto de principio a fin. En la etapa exploratoria, el agrupamiento de comorbilidades sobre las primeras 27 epicrisis permitió identificar perfiles de paciente y dimensionar la viabilidad de la extracción estructurada. En la etapa de evaluación, la comparación de tres modelos de lenguaje sobre una cohorte fija de 20 casos, con 199 variables por caso y evidencia textual verificable, constituye un diseño experimental controlado: mismos casos, mismos campos, condiciones de ejecución registradas, resultados versionados.
...
La dimensión de adopción organizacional es explícita en varios entregables: el manual de anotación interactivo dentro de la propia aplicación, que convierte el protocolo de anotación en ejercicios prácticos; el glosario clínico indexado por campo; la documentación del entorno de cómputo y la norma de ejecutar todo trabajo mediante el planificador de tareas del clúster; y la migración de la base de datos, validada hacia un servicio administrado en la nube y, tras el incidente de agosto, operando en una estación de trabajo dedicada con esa nube como respaldo horario verificado, lo que sacó a la plataforma de una máquina personal y la dejó sobre infraestructura que la organización puede operar. Investigar tecnología nueva es la mitad de la competencia; la otra mitad, dejarla usable por otros, es lo que este proyecto ejercitó de forma sostenida.
