...
A mi profesor guía, Denis Parra, por su orientación y disposición durante el proceso. A mi supervisor Marcelo Andia, por el acompañamiento semanal, las discusiones técnicas y clínicas, y por empujar el proyecto hacia resultados concretos.
...
A mi madre, Yohana, por su apoyo incondicional en cada etapa de este camino. A mis abuelos, Carmen y David, por todo lo que hicieron para que yo pudiera estudiar tranquilo.
...
The project also required solving problems inherent to a production system: personal data protection over 275 real epicrises, database migration to a managed cloud service, verified backups, and availability monitoring. The work provided evidence for the three declared graduate profile competencies: developing innovative solutions based on advanced Computer Science engineering knowledge, applying diverse data analysis methods, and researching and facilitating the adoption of new information technologies within a healthcare organization.
\newpage
...
iHealth es un instituto de investigación que reúne a médicos, ingenieros y científicos de datos con el propósito de llevar herramientas de inteligencia artificial a la práctica clínica chilena. El proyecto en que se enmarca este trabajo nace de una necesidad concreta de la Unidad de Paciente Crítico (UPC) del Hospital Dr.\ Sótero del Río: la incertidumbre terapéutica en pacientes críticos, en particular en torno al uso de la hemofiltración de alto volumen (HFAV), una terapia cuya indicación y resultados son difíciles de evaluar retrospectivamente porque la información relevante está dispersa en registros narrativos.
...
Implementar un sistema de software clínico que integre inteligencia artificial para el análisis automatizado de registros médicos y la predicción de eventos clínicos en pacientes de Unidades de Cuidados Intensivos.
...
\begin{enumerate}
    ...
    \item Medir la confiabilidad del conjunto de referencia mediante un experimento de concordancia entre anotadores.
    \item Estudiar arquitecturas de predicción de eventos clínicos (Delphi-2M, TFT, Foresight) como base para el análisis predictivo sobre los datos estructurados.
\end{enumerate}

\subsubsection{Metodología}

El proyecto se organizó en áreas de desarrollo consecutivas y superpuestas. La primera área correspondió al software de extracción: la plataforma de anotación, su base de datos, la anonimización y el visor seguro de documentos. La segunda, a la evaluación de modelos de lenguaje sobre el clúster de cómputo ih-condor, incluyendo el diseño de un procedimiento de extracción por dominios clínicos. La tercera, al estudio de arquitecturas de predicción de eventos clínicos y a la preparación de los datos que esos modelos requieren.
...
El paso de prototipo a sistema en uso exigió infraestructura seria. La base de datos se trasladó desde un computador local a un servicio administrado en la nube en la región sudamericana, con conexión cifrada y verificación efectiva del certificado del servidor.
...
El proyecto exigió investigar tecnología que ni el estudiante ni la organización dominaban al inicio, y dejarla operativa para otros. El estudiante completó un programa de formación en aprendizaje profundo y modelos de lenguaje, estudió arquitecturas de predicción de eventos clínicos (Delphi-2M, TFT, Foresight) y llevó ese estudio a la práctica: la evaluación de Gemma, Llama-70B y Qwen sobre el clúster ih-condor requirió resolver problemas concretos de adopción, desde la reserva de múltiples tarjetas gráficas para los modelos grandes hasta la constatación de que los nodos del clúster no alcanzan el repositorio público de paquetes, con su procedimiento de instalación documentado para el resto del equipo.
